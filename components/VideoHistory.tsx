    ...
    return (
        <div className="bg-gray-800 rounded-2xl shadow-lg p-6 w-full">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-cyan-400">Generation History</h2>
                <button
                    onClick={handleClear}
                    className="text-xs bg-red-800/70 text-red-300 font-semibold py-1 px-3 rounded-full hover:bg-red-700 transition-colors flex items-center gap-1"
            ...
            <div className="flex overflow-x-auto space-x-4 pb-4 -mb-4">
                {history.map((item) => (
                    <div
                        ...
                        className={`group relative flex-shrink-0 w-48 rounded-lg cursor-pointer overflow-hidden transform transition-all duration-300 hover:scale-105 ${
                            item.videoUrl === activeVideoUrl ? 'ring-4 ring-cyan-500 shadow-xl' : 'ring-2 ring-gray-700 hover:ring-cyan-600'
                        }`}
                    >
                        <button 
                        ...
                        <div className="relative">
                            <img src={item.thumbnailUrl} alt="Video thumbnail" className="w-full h-28 object-cover bg-gray-900" />
                        ...
                        <div className="p-2 bg-gray-700">
                             <p className="text-xs text-gray-300 truncate" title={item.script}>
                                {item.script}
                            </p>
